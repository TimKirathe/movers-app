...
public class Intro1Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        if(view == tab1){
            Intent intent =new Intent(Intro1Activity.this,Intro1Activity.class);
            startActivity(intent);
        }else if(view == tab2){
            Intent intent =new Intent(Intro1Activity.this,Intro2Activity.class);
            startActivity(intent);
        }else if(view == tab3){
            Intent intent =new Intent(Intro1Activity.this,Intro3Activity.class);
            startActivity(intent);
        }else if(view == skip) {
